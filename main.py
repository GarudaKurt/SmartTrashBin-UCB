...
arduino = serial.Serial('COM_PORT', 9600)  # Replace COM_PORT with the correct port
...
while True:
    ...
    detected_class = None  # Variable to store the detected class to send
    ...
    # Check the time and send serial data dynamically
